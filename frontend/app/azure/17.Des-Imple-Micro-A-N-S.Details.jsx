...
import Image from "../images/Cloud/Azure/9.azure-network-engineer-associate AZ 700.png";
          ...
          <div className="details-items">
            ...
            <div className="item">
              <div className="image-container">
                <img src={Image} alt="Azure Networking Solutions" />
              </div>
                ...
                <div className="content-wrapper">
                  ...
                  >
                    <div className="concept-data">
                      <div className="data-item">
                        📌 1: Azure Virtual Networks Fundamentals
                      </div>
                      <div className="data-item">
                      ...
                      <div className="data-item">
                        📌 8: Capstone Project and AZ-700 Prep
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className="course-data">
                      ...
                      <ul>
                        ...
                        <li>
                          Configure hybrid connections using VPN and ExpressRoute
                        </li>
                        <li>
                        ...
                        <li>
                          Implement private and public DNS solutions
                        </li>
                        <li>
                          Monitor and troubleshoot network performance
                        </li>
                        <li>
                          Automate network deployments with Infrastructure as Code
                        </li>
                        <li>
                      ...
                      <h4>Certification:</h4>
                      <p>
                        Course prepares you for Microsoft Certified: Azure Network Engineer Associate (AZ-700) exam. Includes one free exam attempt voucher.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="Roles-container">
                      ...
                      <ul>
                        <li>
                          <strong>Azure Network Engineer:</strong> Design and implement Azure networking solutions
                        </li>
                        <li>
                          <strong>Cloud Network Architect:</strong> Plan and optimize cloud network infrastructure
                        </li>
                        <li>
                          <strong>Network Security Specialist:</strong> Secure cloud network environments
                        </li>
                        <li>
                          <strong>Cloud Infrastructure Engineer:</strong> Implement and manage cloud networking components
                        </li>
                        <li>
                          <strong>DevOps Engineer (Networking):</strong> Automate network deployments
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="item">
              <div className="text">
                <h1>Azure Networking Solutions</h1>
                <p>
              ...
              <div className="text">
                ...
                <p>
                  This course prepares you for the Microsoft Certified: Azure Network Engineer Associate certification (AZ-700), validating your ability to design, implement, and maintain Azure networking solutions.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Preparation for AZ-700 certification exam
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
                    ...
                    <li>
                      ...
                      Access to Azure networking resources
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
              ...
              <div className="text">
                ...
                <p>
                  Azure Virtual Networks, VPN Gateway, ExpressRoute, Network Security Groups, Azure Firewall, Load Balancer, Application Gateway, Traffic Manager, Azure DNS, Private Link, Network Watcher, and ARM/Bicep templates.
                </p>
              </div>
            </div>
            {/* == Third Item */}
              ...
              <div className="course-info">
                ...
                <div className="info-text">
                  ...
                  <p>
                    ...
                    Azure networking resources for hands-on labs. Basic networking knowledge is recommended.
                  </p>
                </div>
