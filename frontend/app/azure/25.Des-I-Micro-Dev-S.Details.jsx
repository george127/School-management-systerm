...
import Image from "../images/Cloud/Azure/17.CERT-Expert-DevOps-Engineer.AZ-400.png";
          ...
          <div className="details-items">
            ...
            <div className="item">
              <div className="image-container">
                <img src={Image} alt="Designing and Implementing Microsoft DevOps Solutions" />
              </div>
                ...
                <div className="content-wrapper">
                  ...
                  >
                    <div className="concept-data">
                      ...
                      <div className="data-item">
                        📌 2: Azure DevOps and GitHub Ecosystem
                      </div>
                      <div className="data-item">
                        📌 3: Source Control with Git
                      </div>
                      <div className="data-item">
                        📌 4: CI/CD Pipelines Implementation
                      </div>
                      <div className="data-item">
                  ...
                  >
                    <div className="course-data">
                      ...
                      <h4>Certification:</h4>
                      <p>
                        Course prepares you for Microsoft Certified: DevOps Engineer Expert (AZ-400) exam. Includes one free exam attempt voucher.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="Roles-container">
                      ...
                      <ul>
                        <li>
                          <strong>DevOps Engineer:</strong> Implement and manage CI/CD pipelines
                        </li>
                        <li>
                          <strong>Cloud DevOps Specialist:</strong> Automate cloud deployments
                        </li>
                        <li>
                          <strong>Release Manager:</strong> Oversee software releases
                        </li>
                        <li>
                          <strong>Site Reliability Engineer (SRE):</strong> Ensure system reliability
                        </li>
                        <li>
                          <strong>Automation Architect:</strong> Design automation solutions
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="item">
              <div className="text">
                <h1>Designing and Implementing Microsoft DevOps Solutions</h1>
                <p>
              ...
              <div className="text">
                ...
                <p>
                  This course prepares you for the Microsoft Certified: DevOps Engineer Expert certification (AZ-400). The certification validates your ability to combine people, processes, and technologies to continuously deliver valuable products and services.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Preparation for AZ-400 certification exam
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
              ...
              <div className="text">
                ...
                <p>
                  Azure DevOps, GitHub Actions, Azure Pipelines, Azure Repos, Azure Artifacts, Azure Boards, ARM templates, Terraform, Bicep, Azure Monitor, and Azure Security Center.
                </p>
              </div>
            </div>
            {/* == Third Item */}
              ...
              <div className="course-info">
                ...
                <div className="info-text">
                  ...
                  <p>
                    ...
                    Azure DevOps and GitHub for hands-on labs. Basic programming knowledge is recommended.
                  </p>
                </div>
