...
import Image from "../images/Cloud/Azure/7.Developing Solutions for Microsoft Azure AZ-204.webp";
          ...
          <div className="details-items">
            ...
            <div className="item">
              <div className="image-container">
                <img src={Image} alt="Developing Solutions for Microsoft Azure" />
              </div>
                ...
                <div className="content-wrapper">
                  ...
                  >
                    <div className="concept-data">
                      <div className="data-item">
                        📌 1: Azure Development Fundamentals
                      </div>
                      <div className="data-item">
                      ...
                      <div className="data-item">
                        📌 5: Monitoring, Troubleshooting and Optimizing Solutions
                      </div>
                      <div className="data-item">
                  ...
                  >
                    <div className="course-data">
                      ...
                      <ul>
                        <li>
                          Develop Azure compute solutions using VMs, containers, and serverless technologies
                        </li>
                        <li>
                          Implement Azure storage solutions including blobs, files, and Cosmos DB
                        </li>
                        <li>
                          Secure applications using Azure Active Directory and Key Vault
                        </li>
                        <li>
                          Monitor and optimize Azure solutions
                        </li>
                        <li>
                          Connect applications to Azure services using REST APIs and SDKs
                        </li>
                        <li>
                      ...
                      <p>
                        Instructor-led training with hands-on coding labs in live Azure environment. Includes access to Azure development resources.
                      </p>

                      <h4>Certification:</h4>
                      <p>
                        Course prepares you for Microsoft Certified: Azure Developer Associate (AZ-204) exam. Includes one free exam attempt voucher.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="Roles-container">
                      ...
                      <ul>
                        <li>
                          <strong>Azure Developer:</strong> Build and maintain cloud-native applications on Azure
                        </li>
                        <li>
                          <strong>Cloud Application Developer:</strong> Design and implement scalable cloud solutions
                        </li>
                        <li>
                          <strong>Full Stack Developer (Azure):</strong> Develop end-to-end solutions using Azure services
                        </li>
                        <li>
                          <strong>DevOps Engineer (Azure):</strong> Implement CI/CD pipelines for Azure applications
                        </li>
                        <li>
                          <strong>Cloud Solutions Developer:</strong> Create custom solutions leveraging Azure services
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="item">
              ...
              <div className="text">
                ...
                <p>
                  This course prepares you for the Microsoft Certified: Azure Developer Associate certification (AZ-204). The certification validates your ability to design, build, test, and maintain cloud applications and services on Azure.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Preparation for AZ-204 certification exam
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
              ...
              <div className="text">
                ...
                <p>
                  Azure App Services, Azure Functions, Azure Kubernetes Service, Azure Storage, Cosmos DB, Azure Active Directory, Azure Key Vault, Azure Monitor, Azure API Management, Azure Service Bus, and other Azure development services.
                </p>
              </div>
            </div>
            {/* == Third Item */}
              ...
              <div className="course-info">
                ...
                <div className="info-text">
                  ...
                  <p>
                    ...
                    Azure development resources for hands-on labs. Basic programming knowledge is recommended.
                  </p>
                </div>
