...
import Image from "../images/Marketing/image7.png";
          ...
          <div className="details-items">
            ...
            <div className="item">
              <div className="image-container">
                <img src={Image} alt="Pinterest Marketing Certification" />
              </div>
                ...
                <div className="content-wrapper">
                  ...
                  >
                    <div className="concept-data">
                      <div className="data-item">
                        📌 1: Pinterest Marketing Fundamentals
                      </div>
                      <div className="data-item">
                        📌 2: Pinterest Business Account Setup
                      </div>
                      <div className="data-item">
                        📌 3: Pinterest SEO & Content Strategy
                      </div>
                      <div className="data-item">
                        📌 4: Pinterest Advertising (PPC)
                      </div>
                      <div className="data-item">
                        📌 5: Pinterest Analytics & Reporting
                      </div>
                      <div className="data-item">
                        📌 6: Pinterest Shopping & E-commerce Integration
                      </div>
                      <div className="data-item">
                        📌 7: Advanced Pinterest Strategies
                      </div>
                      <div className="data-item">
                        📌 8: Pinterest Certification Preparation
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className="course-data">
                      ...
                      <ul>
                        <li>
                          Set up and optimize Pinterest business accounts
                        </li>
                        <li>
                          Master Pinterest SEO and content strategy
                        </li>
                        <li>
                          Create effective Pinterest ad campaigns
                        </li>
                        <li>
                          Implement Pinterest shopping features
                        </li>
                        <li>
                          Analyze Pinterest analytics for optimization
                        </li>
                        <li>
                          Develop advanced Pinterest marketing strategies
                        </li>
                        <li>
                          Prepare for Pinterest certification exams
                        </li>
                      </ul>
                      ...
                      <p>
                        Hands-on training with live Pinterest account demonstrations and real campaign management.
                      </p>

                      <h4>Certification:</h4>
                      <p>
                        Prepares for official Pinterest marketing certifications and provides our institute's certification.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="Roles-container">
                      ...
                      <ul>
                        <li>
                          <strong>Pinterest Marketing Specialist</strong> - Manage Pinterest accounts and campaigns
                        </li>
                        <li>
                          <strong>Social Media Manager</strong> - Oversee Pinterest strategy
                        </li>
                        <li>
                          <strong>E-commerce Pinterest Strategist</strong> - Optimize product pins and shopping
                        </li>
                        <li>
                          <strong>Content Marketer</strong> - Create Pinterest-optimized content
                        </li>
                        <li>
                          <strong>Freelance Pinterest Consultant</strong> - Offer expert services to businesses
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="item">
              ...
              <div className="text">
                ...
                <p>
                  Earn our official Pinterest Marketing Certification and prepare for Pinterest's own certification programs.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  6-week program with 30 instructor-led hours and 40+ practical hours.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  ...
                  <ul>
                    <li>
                      ...
                      Hands-on with Pinterest business tools
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
                    ...
                    <li>
                      ...
                      Learn Pinterest advertising (PPC)
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
              ...
              <div className="text">
                ...
                <p>
                  Pinterest Business, Pinterest Ads Manager, Pinterest Analytics, Pinterest Shopping, and optimization tools.
                </p>
              </div>
            </div>
            {/* == Third Item */}
            <div className="item">
              ...
              <div className="course-info">
                ...
                <div className="info-text">
                  ...
                  <p>
                    <b>Requirements:</b> Pinterest business account and basic understanding of social media marketing.
                  </p>
                </div>
