...
import Image from "../images/Analytics/image1.png";
          ...
          <div className="details-items">
            ...
            <div className="item">
              <div className="image-container">
                <img src={Image} alt="Cloud Data Analytics Professional Certification" />
              </div>
                ...
                <div className="content-wrapper">
                  ...
                  >
                    <div className="concept-data">
                      ...
                      <div className="data-item">
                        📌 2: Big Data Processing in Cloud
                      </div>
                      <div className="data-item">
                  ...
                  >
                    <div className="course-data">
                      ...
                      <ul>
                        <li>
                          Design and implement cloud data solutions
                        </li>
                        <li>
                          Process big data using cloud-native tools
                        </li>
                        <li>
                        ...
                        <li>
                          Integrate machine learning with data pipelines
                        </li>
                        <li>
                          Ensure data governance and security compliance
                        </li>
                        <li>
                          Prepare for cloud platform certifications
                        </li>
                      </ul>
                      ...
                      <p>
                        Hands-on labs using AWS, Azure, and Google Cloud platforms with real-world datasets and scenarios.
                      </p>

                      <h4>Certification:</h4>
                      <p>
                        Prepares for AWS Certified Data Analytics, Google Professional Data Engineer, and Microsoft Azure Data Scientist certifications.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="Roles-container">
                      ...
                      <ul>
                        <li>
                          <strong>Cloud Data Engineer</strong> - Design and implement cloud data solutions
                        </li>
                        <li>
                          <strong>Big Data Analyst</strong> - Process and analyze large datasets
                        </li>
                        <li>
                          <strong>Data Warehouse Specialist</strong> - Implement cloud DW solutions
                        </li>
                        <li>
                          <strong>BI Developer</strong> - Create cloud-based analytics solutions
                        </li>
                        <li>
                          <strong>Data Architect</strong> - Design multi-cloud data strategies
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="item">
              <div className="text">
                <h1>Cloud Data Analytics Certification</h1>
                <p>
                  Become a certified cloud data analytics professional with this comprehensive training covering data engineering, warehousing, and advanced analytics on AWS, Azure, and Google Cloud platforms.
                </p>
              </div>
              ...
              <div className="text">
                ...
                <p>
                  Prepares for AWS, Azure, and Google Cloud data certifications plus our institute's professional certification.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  10-week program with 60 instructor-led hours and 80+ lab hours.
                </p>
              </div>
              <div className="text">
                <h4>
                ...
                <p>
                  ...
                  <ul>
                    <li>
                      ...
                      Hands-on with AWS, Azure, and Google Cloud
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
                      </span>
                      Master big data processing techniques
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
                      </span>
                      Learn real-time analytics implementation
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
                      </span>
                      Gain multi-cloud certification preparation
                    </li>
                    <li>
                      <span className="material-symbols-outlined">
                        done_all
                      </span>
                      Develop portfolio-worthy cloud projects
                    </li>
                  </ul>
                </p>
              </div>
              <div className="text">
                ...
                <p>
                  AWS Redshift, Azure Synapse, BigQuery, Snowflake, Databricks, Spark, Kafka, Airflow, and cloud ML services.
                </p>
              </div>
            </div>
            {/* == Third Item */}
            <div className="item">
              ...
              <div className="course-info">
                ...
                <div className="info-text">
                  ...
                  <p>
                    <b>Schedule:</b> 10 weeks, 4 sessions/week (Mon/Wed/Fri/Sat)
                  </p>
                </div>
                ...
                <div className="info-text">
                  ...
                  <p>
                    <b>Requirements:</b> Laptop with minimum 8GB RAM. Basic SQL knowledge recommended.
                  </p>
                </div>
              ...
              <div className="course-info">
                ...
                <p>
                  <strong>Cloud credits:</strong> Includes $100 AWS, $100 Azure, and $100 Google Cloud credits for labs.
                </p>
              </div>
            </div>
          </div>
