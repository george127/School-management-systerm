...
const CourseAssignment = () => {
  ...
  const handleStartAssignment = (assignment) => {
    ...
    // In real app, this would navigate to assignment workspace
            ...
            <div key={assignment.id} className="assignment-card">
              ...
              <div className="card-header">
                <div className="course-badge" style={{ 
                  backgroundColor: assignmentData.courses.find(c => c.id === assignment.course)?.color 
                }}>
                  {assignmentData.courses.find(c => c.id === assignment.course)?.name}
                </div>
      ...
      <div className="upcoming-deadlines">
        ...
        <div className="deadlines-list">
          {assignmentData.assignments
            .filter(a => !a.submitted && a.status !== 'overdue')
            .slice(0, 3)
            .map(assignment => (
