...
const CourseMaterial = () => {
  ...
  const filteredMaterials = courseMaterials.materials.filter(material => {
    ...
    <div className="course-material-container">
      ...
      <div className="material-header">
        ...
        <div className="header-stats">
          ...
          <div className="stat-card">
            ...
            <div className="stat-info">
              <span className="stat-number">
                {courseMaterials.materials.filter(m => m.progress === 100).length}
              </span>
          ...
          <div className="stat-card">
            ...
            <div className="stat-info">
              <span className="stat-number">
                {courseMaterials.materials.filter(m => m.isNew).length}
              </span>
      ...
      <div className="search-filter-section">
        ...
        <div className="filter-options">
          ...
          >
            {courseMaterials.categories.map(category => (
        ...
        <div className="categories-sidebar">
          ...
          <div className="recent-downloads">
            ...
            <div className="recent-list">
              {courseMaterials.materials.slice(0, 3).map(material => (
